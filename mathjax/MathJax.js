	...
	if (!MathJax.Hub) {
			...
			b.Object = c({
					...
					Augment : function (g, h) {
						...
						if (g != null) {
							...
							if (g.toString !== this.prototype.toString && g.toString !== {}
		...
		MathJax.Hub = {
			...
			PreProcess : function (e, f) {
				...
				for (var d = 0, a = c.elements.length; d < a; d++) {
					if (c.elements[d]) {
						b.Push(["Post", this.signal, ["Begin PreProcess", c.elements[d]]], (arguments.callee.disabled ? {}

								 : ["Execute", this.preProcessors, c.elements[d]]), ["Post", this.signal, ["End PreProcess", c.elements[d]]])
					}
				}
				return b.Push(c.callback)
			},
			...
			var g = MathJax.Object.Subclass({
					...
					Augment : function (k, j) {
						...
						if (k != null) {
							...
							if (k.toString !== i.prototype.toString && k.toString !== {}
